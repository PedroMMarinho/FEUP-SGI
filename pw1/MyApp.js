...
class MyApp  {
    ...
    init() {
        ...
        this.renderer.shadowMap.type = THREE.PCFSoftShadowMap; // or THREE.PCFShadowMap for sharper edges
    ...
    initCameras() {
		...
		// Persp 2
		const perspective2 = new THREE.PerspectiveCamera( 135, aspect, 0.1, 1000);
